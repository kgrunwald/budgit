                    ...
                    <div class="summary">
                        <div class="available">
                            <div
                                class="balance"
                                :class="{
                                    negative: getAvailableCash(currentMonth) < 0
                                }"
                            >
                                {{
                                    formatCurrency(
                                        getAvailableCash(currentMonth)
                                    )
                                }}
                            </div>
                        ...
                        <div class="available-summary">
                            ...
                            <div class="detail">
                                ...
                                <div>
                                    {{
                                        formatCurrency(getIncome(currentMonth))
                                    }}
                                </div>
                            </div>
                            <div class="detail">
        ...
        <div class="budget-body-container">
            <div class="budget-groups">
                <b-card
                    ...
                    :key="group.id"
                    body-class="budget-group-card-body"
                >
                    <draggable
                        :list="[]"
                        :group="{
                        ...
                        >
                            <div class="group-title-container">
                                <font-awesome-icon
                                    ...
                                    "
                                    @click="
                                        categoriesForGroup(group).length &&
                            ...
                            <div
                                v-if="group.id !== creditCardGroup.id"
                                class="group-actions"
                            >
                                <b-button
                                    pill
                        ...
                        <b-collapse
                            ...
                            :visible="
                                (movingCategory
                                    ...
                                    : !group.hidden) &&
                                    categoriesForGroup(group).length > 0
                            "
                        >
                            <b-list-group class="category-group-container">
                                ...
                                <draggable
                                    ...
                                    @end="onDragEnd"
                                    @change="
                                        event => onDragChange(group, event)
                                    "
                                    :move="onDragMove"
                                >
                                    <b-list-group-item
                                        button
                                        v-for="(category,
                                        index) in categoriesForGroup(group)"
                                        :key="category.id"
                                        ...
                                        "
                                        @click="
                                            rowClicked(group, category, index)
                                        "
                                        :active="
